...
public class ConsultarCargo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta De Cargos Regsitrados");
    ...
    private void btInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInsertarActionPerformed
        AgregarCargo agregar = new AgregarCargo();
    ...
    private void btActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btActualizarActionPerformed
        ...
        if (fila != -1) {
            idCargo = Integer.parseInt(tbDatos.getValueAt(fila, 0).toString());
            ActualizarCargo actualizar = new ActualizarCargo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarCargo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
